...
.DESCRIPTION
    Maintains a JSON queue file (optimization-queue.json) that stores ranked
    ...
    Also regenerates the human-readable optimization-queue.md from the JSON
...
.PARAMETER Action
    ...
    - SyncMarkdown:  Regenerate optimization-queue.md from the JSON
