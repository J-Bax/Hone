    ...
    Runtime = @{
        ...
        Build = @{
            ...
            ByExperiment = @{
                '0' = @{
                    ExitCode = 0
                    Output = 'Fixture baseline build succeeded'
                }
            }
        }
        ...
        Tests = @{
            Default = @{
                ...
                Passed = 4
                Failed = 0
                TrxContent = '<TestRun id="build-failure" />'
            }
        }
        ...
        Scale = @{
            Primary = @{
                Default = @{
                    ...
                    Output = 'Fixture post-build scale run complete'
                }
                ByExperiment = @{
                    '0' = @{
        ...
        Publish = @{
            Default = @{
                SkipPRCreation = $true
                PrNumber = 5102
                PrUrl = 'https://example.invalid/hone/build-failure/pull/5102'
            }
        }
    }
}
