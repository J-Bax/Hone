    ...
    Runtime = @{
        ...
        Tests = @{
            Default = @{
                ...
                Passed = 4
                Failed = 0
                TrxContent = '<TestRun id="regression" />'
            }
        }
        ...
        Scale = @{
            Primary = @{
                Default = @{
                    SummaryPath = '__HARNESS_ROOT__\test-fixtures\k6-results\regressed-summary.json'
                    CounterMetricsPath = '__HARNESS_ROOT__\test-fixtures\diagnostics\runtime-counters.json'
                    Output = 'Fixture regression scale run complete'
                }
                ByExperiment = @{
                    '0' = @{
        ...
        Publish = @{
            Default = @{
                SkipPRCreation = $true
                PrNumber = 5104
                PrUrl = 'https://example.invalid/hone/regression/pull/5104'
            }
        }
    }
}
